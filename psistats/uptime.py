...
#                                                                             #
# There are no official debian packages for this module unfortunately.        #
# There is an optional posix extension not included here. It's not included   #
# as I wasn't able to figure out how to automate a build workflow that        #
# included this extension.                                                    #
#                                                                             #
# Ideally, this would be packaged up as a separate debian package             #
# and hosted externally of course.                                            #
###############################################################################
